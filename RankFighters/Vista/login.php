      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="section-description">Inicia tu cuenta para interactuar junto a nosotros!</p>
          </div>
        </div>
...
<center>
          <div class="col-lg-5 col-md-8">
            <div class="form">
              <form method="post" action="../Control/login.php" role="form">    
                ...
                <a href="register.php">¿Todavia no tienes una cuenta? REGISTRATE!!</a><br><br>


                <div class="text-center">
                <button type="submit" class="btn btn-info" name="login">Iniciar</button>
                </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="copyright">
             Hecho por: <strong>Samuel Henao Lara, Santiago Salcedo, Jeronimo Higuita, Breiner Henao</strong>
          </div>
          <div class="credits">
